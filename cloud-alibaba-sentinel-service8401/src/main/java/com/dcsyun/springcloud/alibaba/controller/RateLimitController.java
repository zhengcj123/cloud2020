...
import com.dcsyun.springcloud.alibaba.myhandler.CustomerHandler;
...
public class RateLimitController {
	...
	@SentinelResource(value = "customerHandler",blockHandlerClass = CustomerHandler.class,blockHandler = "handler1")
